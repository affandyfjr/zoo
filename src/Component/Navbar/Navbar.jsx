  ...
  return (
    ...
    <nav className="relative w-[570px] mt-14 bg-[#D9D9D9] rounded-full py-4 px-3">
      <div className="flex items-center justify-between ">
        <div className="flex-1 text-center text-black hover:underline hover:underline-offset-1">
          Info
        </div>
        <div className="flex-1 text-center text-black hover:underline hover:underline-offset-1 mr-16">
          <NavLink to="/peta">Peta</NavLink>
        </div>

        <NavLink to="/" className="flex justify-center items-center absolute left-1/2 transform -translate-x-1/2 bg-black rounded-full w-24 h-24 ">
        ...
        <div className="flex-1 text-center text-black hover:underline hover:underline-offset-1 ml-16">
          Fauna
        </div>
        <div className="flex-1 text-center text-black hover:underline hover:underline-offset-1">
          About
